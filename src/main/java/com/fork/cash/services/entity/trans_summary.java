...
public class trans_summary {


//    @Where(clause = "transaction_summary_id != NULL")
    private Integer transaction_summary_id;
    private String as_of_dt ;
    private Integer nsp_account_id ;
    private String account_nm ;
    private String account_symbol ;

//    @Id
//    @GeneratedValue(strategy = GenerationType.AUTO)
    private Integer projection_level_id ;
    private Integer projection_level_identifier ;
    ...
    public Integer getTransaction_summary_id() {
        return transaction_summary_id;
    }

    public void setTransaction_summary_id(Integer transaction_summary_id) {
    ...
    public Integer getNsp_account_id() {
        return nsp_account_id;
    }

    public void setNsp_account_id(Integer nsp_account_id) {
    ...
    public Integer getProjection_level_id() {
        return projection_level_id;
    }

    public void setProjection_level_id(Integer projection_level_id) {
        this.projection_level_id = projection_level_id;
    }

    public Integer getProjection_level_identifier() {
        return projection_level_identifier;
    }

    public void setProjection_level_identifier(Integer projection_level_identifier) {
